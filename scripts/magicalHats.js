...
(function() {
  module.exports = function(robot) {
    ...
    robot.hear(/start(\s*)magical/i, function(msg) {
      ...
      if (checkenv !== null) {
        ans = "遊戯「勝負はまだ終わってないぜ！」";
        strMagical = printMagicalHuts(checkenv.list);
        strPoint = printLifePoint(checkenv.point);
        return msg.send(ans + "\n" + strMagical + "\n" + strPoint);
      }
      ...
      strPoint = printLifePoint(point);
      ans = "遊戯「魔法カード、マジカルシルクハット発動！」";
      strMagical = printMagicalHuts(list);
      // 出力
